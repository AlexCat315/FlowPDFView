...
import com.blaze.pdfviewer.util.PdfConstants.Cache.CACHE_SIZE
import com.blaze.pdfviewer.util.PdfConstants.Cache.THUMBNAILS_CACHE_SIZE
...
class CacheManager {
    ...
    val allThumbnails: List<PagePart>
        get() = synchronized(lock = thumbnailsLock) { thumbnails.toList() }
