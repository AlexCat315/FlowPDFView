...
Android view for displaying PDFs rendered with PdfiumAndroid from API 21.
This library builds on Blaze Pdfium (with 16 KB page size support) to provide a modern PDF viewing component.
...
interface [source](https://github.com/blazepdf/BlazePdfium/blob/master/libPdfViewer/src/main/java/com/blaze/pdfviewer/scroll/ScrollHandle.kt).

## Document sources

_Document sources_, which are just providers for PDF documents. Every provider implements **DocumentSource**
interface. Predefined providers are available in **com.blaze.pdfviewer.source.DocumentSource** package and can
